...
const SAMPLE_PLAN = [
  ...
  },
  {
    ...
    date: "2026-03-25",
    location: "University campus gate, Ranchi",
...
const SAMPLE_TIMELINE = [
  ...
  },
  {
    ...
    description:
      "Placeholder timeline entry. Marks the sample handheld footage recorded at a Ranchi university campus gate.",
