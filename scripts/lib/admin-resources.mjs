...
export const MASTER_CSV = path.join(ROOT, "10082026 - Sheet1.csv");
...
// production (reference media served at media.10082026.com).
export const MEDIA_BUCKET = "redsoil-media";

export const RESOURCES = {
  takedown: {
    table: "takedown_requests",
    database: (env) => (env === "staging" ? "redsoil-takedowns-staging" : "redsoil-takedowns"),
  },
  video: {
    table: "video_submissions",
    database: (env) =>
      env === "staging" ? "redsoil-video-submissions-staging" : "redsoil-video-submissions",
  },
};

export const UPLOAD_BUCKET = (env) => (env === "staging" ? "redsoil-uploads-staging" : "redsoil-uploads");
