# Red Soil — 10082026.com

A static archive documenting publicly available videos, photos, and reporting related to the 2026 Jharkhand student protests — the movement against recruitment-exam paper leaks that culminated in the 10 August 2026 march on the Jharkhand Legislative Assembly in Ranchi. Preservation, discoverability, and historical documentation — with attribution always preserved and verification status always shown. No backend, no accounts, no comments.

Forked from the 20072026.com archive (same architecture, same editorial rules, different event).
