...
--     `redsoil-uploads` R2 bucket by src/worker.ts; r2_key is NULL until
--     the upload step (PUT /api/upload/:id) completes.
--
-- Lives in its own D1 database (redsoil-video-submissions /
-- redsoil-video-submissions-staging), separate from redsoil-takedowns,
